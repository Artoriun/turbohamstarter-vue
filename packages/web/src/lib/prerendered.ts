 ...
 *
 * Used to suppress work whose result depends on the capture viewport — poem pagination
 * measures the available height, so a page split at 1280x900 would not match the same poem
